 ...
 function getSchema(tableName){
   switch (tableName) {
     case 'test_table':
       ...
       break;
    case 'rbs_current':
      return "date('yyyy-mm-dd'), type(str), description(str), value(float)";
      break
    case 'homeBudgetExpense':
      return "date('yyyy-mm-dd'), category, subcategoty, value(float), account, payee, note";
    case 'homeBudgetIncome':
      return ':date_col(yyyy-mm-dd), :category, :value(float), :account, :notes';
      break
  ...
  $('#displayForm').submit(function() {
    $.get({
      ...
      cache: false,
      data: {
        tableName: $('input[name="radioTable"]:checked').val()
      }
  ...
  $('#submitForm').submit(function(){
    var raw_input = $('#csv_row').val();
    var parsedCsv = Papa.parse(raw_input);
    console.log(parsedCsv.data);
    $.post({
      url: "/finance/add_row_csv.php",
      data: {
        'csvFormData': parsedCsv,
        'tableName': $('input[name="radioTable"]:checked').val()
      }
  ...
  $('#displayForm').click(function(){
    var table = $('input[name="radioTable"]:checked').val();
    var tableSchema = getSchema(table);
    $('#uploadManager').html(tableSchema);
  });
